            ...
            new MergeJsonWebpackPlugin({
                output: {
                    groupBy: [
                        ...
                        { pattern: "./src/main/webapp/i18n/zh-tw/*.json", fileName: "./build/www/i18n/zh-tw/all.json" },
                        { pattern: "./src/main/webapp/i18n/nl/*.json", fileName: "./build/www/i18n/nl/all.json" },
                        { pattern: "./src/main/webapp/i18n/it/*.json", fileName: "./build/www/i18n/it/all.json" }
